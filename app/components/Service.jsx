      ...
      <div className="listContainer">
        <Slider {...settings}>
          <div className="box p-3 sm:p-5 mt-6 sm:mt-10">
            <div className="bg-gray-100 shadow-lg rounded-lg w-full h-60 sm:h-72 flex flex-col justify-between p-5">
              <h2 className="text-lg sm:text-xl font-semibold mb-2 text-indigo-500">
                Responsive Web Design
              </h2>
              <p className="text-gray-700 text-sm sm:text-base">
                I craft visually appealing websites that seamlessly adapt to various devices, ensuring a consistent and optimal user experience across desktops, tablets, and mobiles.
              </p>
            </div>
          </div>
          ...
          <div className="box p-3 sm:p-5 mt-6 sm:mt-10">
            <div className="bg-gray-100 shadow-lg rounded-lg w-full h-60 sm:h-72 flex flex-col justify-between p-5">
              ...
              <p className="text-gray-700 text-sm sm:text-base">
                Dive into the world of seamless online shopping experiences with E-commerce WebApps. I design and develop dynamic interfaces that glide effortlessly.
              </p>
            </div>
          </div>
